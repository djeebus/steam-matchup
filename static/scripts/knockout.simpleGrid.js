                    ...
                    <table class=\"ko-grid\" cellspacing=\"0\">\
                        ...
                        <tbody data-bind=\"foreach: itemsOnCurrentPage\">\
                           <tr data-bind=\"foreach: $parent.columns\">\
                               <!-- ko if: typeof rowHtml != 'undefined' -->\
                               <td data-bind=\"attr: { 'class': cssClass }, html: typeof rowHtml == 'function' ? rowHtml($parent) : $parent[rowHtml] \"></td>\
                               <!-- /ko -->\
                               <!-- ko if: typeof rowText != 'undefined' -->\
                               <td data-bind=\"attr: { 'class': cssClass }, text: typeof rowText == 'function' ? rowText($parent) : $parent[rowText] \"></td>\
                               <!-- /ko -->\
                            </tr>\
                        </tbody>\
                    </table>");
